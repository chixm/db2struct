...
`
	...
	bytes, err := Generate(columnMap, "test_table", "testStruct", "test", false, false, false, false)
...
`
	...
	bytes, err = Generate(columnMap, "test_table", "testStruct", "test", false, false, false, true)
...
`
	...
	bytes, err := Generate(columnMap, "test_table", "testStruct", "test", true, false, false, false)
...
`
	...
	bytes, err := Generate(columnMap, "test_table", "testStruct", "test", false, true, false, false)
