...
func Generate(columnTypes map[string]map[string]string, tableName string, structName string, pkgName string, jsonAnnotation bool, gormAnnotation bool, dbAnnotation bool, gureguTypes bool) ([]byte, error) {
	var dbTypes string
